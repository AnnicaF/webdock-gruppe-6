...
export default {
    data() {
        return {
            categories: ["Dashboard Features", "Documentation", "Billing Features", "Networking", "Hardware and products", "Perfect Server Stacks", "Mobile App", "Webdock API", "Competition", "Uncategorized" ]
        };
    },
    name: "Modal",
    methods: {
...
.modal {
    ...
    visibility:hidden;
    opacity: 0;
    transition: opacity 0.4s ease-in-out, visability 0.4s ease-in-out, transform 0.4s ease-in-out;
}
